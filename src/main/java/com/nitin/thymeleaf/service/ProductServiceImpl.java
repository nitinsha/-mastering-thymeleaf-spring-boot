...
import com.nitin.thymeleaf.domain.Author;
import com.nitin.thymeleaf.domain.Product;
import com.nitin.thymeleaf.domain.ProductCategory;
...
public class ProductServiceImpl implements ProductService {
	...
	private void loadProducts() {
		...
		Author ni = new Author();
		ni.setFirstName("Nitin");
		ni.setLastName("Insan");
		ni.setId(1);
		ni.setImage("instructor_ni.jpg");
		...
		springCoreUltimate.setAuthor(ni);
